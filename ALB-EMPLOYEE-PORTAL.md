...
5. **Revisión de Ivanhoe del código v1 completo (núcleo + 4 módulos + interfaz).**
6. Sesión con wp-admin para cerrar los 4 puntos de la sección 7 (habilita las escrituras del Gateway: pricing y creación de clientes).
7. Después: vista admin del portal (cola de propuestas y mapeo de usuarios tienen API pero aún no interfaz), despliegue en el sitio y pruebas reales.
